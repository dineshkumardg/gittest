...
class ItemViewTestCase(TestCase):
    def setUp(self):
        ...
        # set test data
        item1 = Item(dom_name='cho_meet_2010_7771_001_0001', dom_id='cho_meet_2010_7771_001_0001')
        item1.save()
        item2 = Item(dom_name=u'cho_meet_2010_7771_001_0002', dom_id='cho_meet_2010_7771_001_0002')
        item2.save()
        item3 = Item(dom_name=u'cho_meet_2010_7771_001_0003', dom_id='cho_meet_2010_7771_001_0003')
        item3.save()
        item4 = Item(dom_name=u'cho_meet_2010_7771_001_0004', dom_id='cho_meet_2010_7771_001_0004')
        item4.save()
    ...
    def test_ItemView_WITHOUT_login(self):
        response = self.client.get("/qa/item/")
        self.assertEqual(response.status_code, 302)

suite = unittest.TestSuite([
    unittest.TestLoader().loadTestsFromTestCase(ItemViewTestCase),
    ])
