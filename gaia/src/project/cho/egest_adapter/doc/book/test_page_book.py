...
class TestPageBook(TestBook):
    def test_cho_book_1929_heald_000_0000(self):
        ...
        expected_document_instances, actual_xml_escaped = self.create_page(dom_name, test_extra_args.cho_book_1929)
...
suite = unittest.TestSuite([
    unittest.TestLoader().loadTestsFromTestCase(TestPageBook),
    ])
