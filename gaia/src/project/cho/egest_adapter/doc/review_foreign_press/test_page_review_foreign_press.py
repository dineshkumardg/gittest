...
class TestPageReviewForeignPress(TestReviewForeignPress):
    def test_cho_rfpx_1939B_0000_001_0000(self):
        ...
        expected_document_instances, actual_xml_escaped = self.create_page(dom_name, test_extra_args.cho_rfpx_1939B_0000)
...
suite = unittest.TestSuite([
    unittest.TestLoader().loadTestsFromTestCase(TestPageReviewForeignPress),
    ])
