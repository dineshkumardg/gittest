...
class TestParentJournal(TestJournal):
    def test_cho_iaxx_1926_0005_000_0000(self):
        ...
        expected_document_instances, actual_xml_escaped = self.create_parent(dom_name, test_extra_args.cho_iaxx_1926_0005)
...
suite = unittest.TestSuite([
    unittest.TestLoader().loadTestsFromTestCase(TestParentJournal),
    ])
